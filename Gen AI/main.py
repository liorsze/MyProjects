...
def extract_parameters(user_input):
    ...
    for ent in doc.ents:
        if ent.label_ == "PRODUCT":
            ...
            if manufacturer_id:
                manufacturers.append(str(manufacturer_id))
...
def main():
    user_input = "i am looking for an executive car from the last decade that costs between 5000$-7000$ and is made by Toyota or mazda."#input("Enter your search query: ")
